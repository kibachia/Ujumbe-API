...
<head>
    <meta charset="utf-8">
    <title>Validation Demo | Sent API</title>
			...
			<div class="row">
				...
				<div class="col-md-6">
					...
					<h3>
						...
						Sent. <small>Validation Demo</small>
					</h3>
    					...
    					<div class="tab-pane active" id="form">
    						...
    						<div class="row margin-bottom-15">
    							...
    							<div class="col-md-9">
    								...
    								<p>
    									This form uses several validation fields to validate certain data. For a closer look, please have a peak under the "The Code" tab.
    								</p>
